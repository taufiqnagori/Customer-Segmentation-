...
window.config(bg="#1e1e1e", pady=20, padx=20)
...
frame = Frame(window, bg='#2b2b2b', relief=SUNKEN, highlightthickness=5, highlightbackground='#4a4a4a')
frame.pack(fill=BOTH, expand=True)

heading = Label(frame, text="Customer Segmentation", font="Arial 30 bold", bg="#ff6f61", padx=30, fg="white")
heading.pack(pady=10)

frame2 = Frame(frame, bg="#2b2b2b", highlightthickness=5, highlightbackground="#ff6f61", padx=30, highlightcolor="#ff6f61")
frame2.pack(pady=20)

select_csv = Label(frame2, text="Select CSV File:", font="Arial 20 bold", bg="#2b2b2b", fg="white")
select_csv.grid(row=2, column=0, pady=10, padx=10)

browse_file = Button(frame2, text="Select CSV File", font="Arial 14 bold", bg="#ff6f61", fg="white", command=load_file)
browse_file.grid(row=2, column=1, pady=10, padx=10)

features_label = Label(frame2, text="Select Features for Clustering:", font="Arial 20 bold", bg="#2b2b2b", fg="white")
features_label.grid(row=3, column=0, pady=10, padx=10)
features_entry_var = StringVar()

features_entry = Entry(frame2, textvariable=features_entry_var, width=30, font="Arial 14 bold", bg="#ff6f61", fg="white")
features_entry.grid(row=3, column=1, pady=10, padx=10)

cluster_label = Label(frame2, text="Number of Clusters:", font="Arial 20 bold", bg="#2b2b2b", fg="white")
cluster_label.grid(row=4, column=0, pady=10, padx=10)
cluster_entry_var = StringVar()
cluster_entry = Entry(frame2, textvariable=cluster_entry_var, width=30, font="Arial 14 bold", bg="#ff6f61", fg="white")
cluster_entry.grid(row=4, column=1, pady=10, padx=10)

segment_button = Button(frame2, text="Segment Clusters", font="Arial 14 bold", bg="#ff6f61", fg="white", command=segment_customer)
